...
const JobDetailsPC = ({ jobPost }: { jobPost: JobPost }) => {
  ...
  return (
    <div className='hidden sm:flex flex-col sm:flex-row gap-2 col-span-3 lg:text-base justify-evenly lg:flex-row lg:col-span-4 *:border *:border-black *:shadow-md *:sm:text-xs *:lg:text-sm'>
