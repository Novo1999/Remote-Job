    ...
    <Card className='font-poppins bg-gradient-to-r from-teal-200 to-lime-200 h-full sm:col-span-1'>
      <CardHeader>
        ...
        <CardDescription className='text-xs leading-6 text-black lg:text-base'>
          ...
          company specializing in the field of technology and software
          development. Known for its cutting-edge solutions and forward-thinking
          approach, Tech Co is at the forefront of the industry. The company is
          committed to delivering high-quality digital products and services
          that cater to the evolving needs of its clients. With a strong focus
          on web development, Tech Co leverages modern technologies such as
