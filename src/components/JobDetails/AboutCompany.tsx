    ...
    <Card className='font-poppins bg-gradient-to-r from-teal-200 to-lime-200'>
      <CardHeader>
        ...
        <CardDescription className='text-xs leading-6 text-black lg:text-base'>
          ...
          enhancement and growth. As a tech enthusiast, you'll find Tech Co to
          be an exciting and vibrant workplace, where creativity and technical
          expertise converge to create impactful digital solutions. Whether it's
          through developing state-of-the-art web applications or exploring new
          technologies, Tech Co remains dedicated to pushing the boundaries of
