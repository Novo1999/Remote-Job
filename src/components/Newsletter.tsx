        ...
        <div className='flex flex-col gap-6'>
          ...
          <div className='mt-4 sm:w-full lg:mt-0 lg:flex-1'>
            <form method='post' className='sm:flex relative'>
              ...
              />
              <button className='bg-white text-black absolute 2xl:relative 2xl:right-2 2xl:rounded-r-lg 2xl:hover:text-black 2xl:pr-2 2xl:top-0 right-2 text-2xl top-2'>
                <FaArrowCircleRight />
              </button>
              <input
                type='checkbox'
